...
const MyAdoptions = () => {
  ...
  return (
    <div style={{
      ...
      <h1 style={{ fontSize: 28, fontWeight: 700, color: '#4f46e5', marginBottom: 24 }}>
        My Adoptions
      </h1>
      {adoptions.length === 0 ? (
        <div style={{
        ...
        <div style={{
          ...
          {adoptions.map(adoption => (
            <div key={adoption.id} style={{
              ...
              />
              <div style={{ fontWeight: 600, fontSize: 20, color: '#374151', marginBottom: 8 }}>
                {adoption.petName}
              </div>
              ...
              <div style={{ color: '#6b7280', fontSize: 15, marginBottom: 4 }}>
                Submitted on: <span style={{ color: '#6366f1', fontWeight: 500 }}>
